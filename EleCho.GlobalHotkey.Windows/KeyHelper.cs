...
namespace EleCho.GlobalHotkey.Windows
{
    ...
    {
        public static uint GetNativeModifierKeys(ModifierKeys modifiers)
        {
            return (uint)modifiers;
        }

        public static ModifierKeys GetModifierKeysFromNative(uint modifiers)
        {
            return (ModifierKeys)modifiers;
        }

        public static uint GetNativeKey(Key key)
        {
            return key switch
            {
                Key.Cancel => 3,
        ...
        public static Key GetKeyFromNative(uint virtualKey)
        {
            switch (virtualKey)
            {
                case 3:
